...
print("输入回车关闭此窗口，输入d后回车删除此程序！")
key = input()
if key == "d":
	while True:
		print("确定删除吗？输入[ yes / no ] 回车确认！")
		affirm = input()
		if affirm == "yes":
			try:
				...
				slow_print("铁锅不可以炖自己，所以我也不可以删除自己，哈哈哈！")
				time.sleep(5)
				break
			slow_print("铁锅不可以炖自己，所以我也不可以删除自己，哈哈哈！")
			time.sleep(8)
			break
		if affirm == "no":
			slow_print("You choose to save this program!")
			time.sleep(5)
			break
		slow_print("This program will work next time!")
		time.sleep(1)
